...
class Config:
    ...
    DRUG_RESPONSE_PATH = '~/jupyterlab/GSE247689/gdsc30_olaparib.csv'
    SINGLE_CELL_EXPR_PATH = '~/jupyterlab/GSE247689/GSE247689cov362_c_t20tpm.csv'
    BULK_PATHWAY_PATH = '~/jupyterlab/bulk_pathwayscoreMatrix.csv'
    SC_PATHWAY_PATH = '~/jupyterlab/GSE247689/GSE247689cov362_c_t20_pathwayscoreMatrix.csv'
